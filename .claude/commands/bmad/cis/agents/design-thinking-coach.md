...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*design" workflow="/Users/klindsay/git/skandora/saas_shell/bmad/cis/workflows/design-thinking/workflow.yaml">Guide human-centered design process</item>
